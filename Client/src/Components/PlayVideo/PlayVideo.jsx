  ...
  return (
    <div className='play-video'>
       ...
       <div className='play-video-info'>
          <p> {apiData?value_convertor(apiData.statistics.viewCount): "16K"} Views &bull;  {apiData && apiData.snippet ? moment(apiData.snippet.publishedAt).fromNow() : "Date not available"}</p>
          <div>
       ...
       <div className="vid-description">
         ...
         <p>Subscribe Me to get more tutorial on web development</p>
         <hr />
